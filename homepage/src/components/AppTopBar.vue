    ...
    <div class="fluent-app-bar__content">
      <div class="fluent-app-bar__left">
        ...
        <RouterLink to="/" class="fluent-app-bar__title-link">
          <img src="../assets/logo.svg" width="26" height="26" alt="糖纸图标" style="border-radius: 6px; margin-right: 8px" />
          <h1 class="fluent-app-bar__title">糖纸 · SugarPaper</h1>
        </RouterLink>
