...
const Map<String, String> kStrokeIcons = {
  ...
  'cloud': 'M7 18a4 4 0 1 1 .5-7.97A5.5 5.5 0 0 1 18 13.5 3.5 3.5 0 0 1 17 20z',
  'wave': 'M2 12c2.5-3 5.5-3 8 0s5.5 3 8 0 3.5-2 4-1',
  'leaf': 'M4 20C4 10 10 4 20 4c0 10-6 16-16 16zM4 20c5-7 9-11 13-13',
  'cup': 'M5 8h14v4a5 5 0 0 1-5 5h-4a5 5 0 0 1-5-5zM5 8V6h14v2M9 21h6',
  'star': 'M12 2l2.4 7.6L22 12l-7.6 2.4L12 22l-2.4-7.6L2 12l7.6-2.4z',
};
