...
(function (g) {
  ...
  const FILL = {
    ...
    cloud: '<path d="M7 18h9.5a4 4 0 0 0 .6-7.9A6 6 0 0 0 5.3 9.6 4.5 4.5 0 0 0 7 18z"/>',
    leaf: '<path d="M5 19C5 9.5 11.5 4.5 20 4c0 8.5-5 15-15 15z"/><path d="M5 19c3-5.5 7.5-9.5 11.5-11.5"/>',
    wave: '<path d="M2 13c2.4-3 4.8-3 7.2 0s4.8 3 7.2 0 4.8-3 7.6 0"/><path d="M2 18c2.4-3 4.8-3 7.2 0s4.8 3 7.2 0 4.8-3 7.6 0"/>',
    cup: '<path d="M4 8h12v5a5 5 0 0 1-5 5H9a5 5 0 0 1-5-5z"/><path d="M16 9h2a3 3 0 0 1 0 6h-2"/><path d="M7 3v2M11 3v2M15 3v2"/>'
  };
